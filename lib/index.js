	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function buildPreviews(urls, optimisticUrls, inButton) {
			...
			var _props = this.props,
			    ...
			    closeElement = _props.closeElement,
					...
					if (url) {
						...
						return _react2.default.createElement(
							...
							!inButton ? _react2.default.createElement(
								...
								closeElement || _react2.default.createElement(
									'svg',
		...
		value: function buildClose() {
			...
			var _props4 = this.props,
			    ...
			    closeElement = _props4.closeElement;
...
ImagesUploader.propTypes = {
	...
	closeElement: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.element]),
